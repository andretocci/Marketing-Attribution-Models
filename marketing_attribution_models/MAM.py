...
if __name__ == "__main__":
    ...
    _, res = model.attribution_first_click()
    print(res)
    _, res = model.attribution_last_click()
    print(res)
    _, res = model.attribution_last_click_non("z")
    print(res)
    _, res = model.attribution_linear()
    print(res)
    _, res = model.attribution_position_based()
    print(res)
    res = model.attribution_markov()
    print(res)
